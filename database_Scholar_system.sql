...
ALTER SCHEMA dba_schema TRANSFER dbo;
...
CREATE USER designer FOR LOGIN design_login WITH DEFAULT_SCHEMA = dba_schema;

CREATE USER admin FOR LOGIN admin_login WITH DEFAULT_SCHEMA = dba_schema;
